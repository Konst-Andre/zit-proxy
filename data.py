...
UI = {
    "ua": {
        ...
        "help": (
            ...
            "• /search — пошук в інтернеті (у режимі /chat)\n"
        ...
        "subject_prompt": "✍️ <b>Введи тему</b>\n\nОпиши що зобразити. Можна українською — перекладеться автоматично.",
        "scene_prompt": "🎬 <b>Сцена</b>\n\nОбери тип кадрування:",
        "style_group_prompt": "🎨 <b>Категорія стилю</b>\n\nОбери категорію:",
    ...
    "en": {
        "welcome": (
            ...
            "💡 Use in any chat: @username_bot query\n\n"
   ...
   "style_group_prompt": "🎨 <b>Style category</b>\n\nSelect a category:",
